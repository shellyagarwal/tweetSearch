...
function addDefault(image, url, id){
	$ = jQuery.noConflict();
	$('body').append('<div class="hk-dpop hk-dpopVCard animated bounceInRight" style="display:block!important;"><div class="hk-dpop-box" style="height:auto;"><a href="' + url + "~" + ext_id + '" target="_blank" class="hk-dpop-wrap"><img src="' + image + '" alt="Dynamic Offer"></a></div><div class="hk-dpop--close">&times;</div></div>');
	attachListeners(id);
}
