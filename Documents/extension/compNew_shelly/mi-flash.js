...
redmi5A.push([['2G+16G', 'Dark Grey', '4174600002'],['2G+16G', 'Gold', '4174600001']]);
...
function startSale(){
  if(window.location.href.split("/hdindex/version/").length>1){
    ...
    if(!document.getElementById('pop-alert-ams')){
      $('body').append('<div id="pop-alert-ams" class="hk-green" style="display:block;height:280px!important;"><div id="p-logo"><img src="' + imgLogo + '"></div><div id="p-msg"><a target="_blank" style="text-decoration:none;color:white;font-size:14px;font-family:calibri" href="https://compare.buyhatke.com/options/#mi-details"><p>We will add ' + prodName + ' to the cart as soon as it is available for sale. Make sure you system timing is correct. Match it with http://bit.ly/2sEtPIP <br>Time Remaining : <span id="ourTimer"></span></p></a></div>' + variantStr + '</div>'); 
    }
    else {
...
function showSubsMessage(data, passBack){
  if(data==1){
    ...
    // a = "what about this";
    if(!document.getElementById('pop-alert-ams')){
    $('body').append('<div id="pop-alert-ams" class="hk-green" style="display:block;height:280px!important;"><div id="p-logo"><img src="' + imgLogo + '"></div><div id="p-msg"><a id="subscribeNow" target="_blank" style="text-decoration:none;color:white;font-size:14px;font-family:calibri" href="https://compare.buyhatke.com/options/#mi-details"><p>Click me to subscribe to autobook ' + prodName + ' during flash Sale starting  ' + timeConverter(saleTime) + '.&nbsp;&nbsp;<br> We will give variant selection option on the day of sale on this page.</p></a></div>' + variantStr + '</div>');
  }
  else{
